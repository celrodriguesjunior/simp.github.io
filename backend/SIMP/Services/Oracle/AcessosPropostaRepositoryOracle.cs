...
namespace SIMP.Services.Oracle{
    ...
    public class AcessosPropostaRepositoryOracle : TableBaseRepositoryOracle, IAcessosPropostaRepository{
        ...
        public async Task<bool> Delete(AcessosProposta Model){
            throw new System.NotImplementedException();
        }

        public async Task<IEnumerable<AcessosProposta>> GetAll(){
        ...
        public async Task<bool> Insert(AcessosProposta Model){
            throw new System.NotImplementedException();
        }
        
        public async Task<bool> Update(AcessosProposta Model){
            throw new System.NotImplementedException();
        }
    }
