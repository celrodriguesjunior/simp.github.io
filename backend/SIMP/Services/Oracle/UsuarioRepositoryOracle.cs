...
namespace SIMP.Services.Oracle{    
    ...
    public class UsuarioRepositoryOracle : TableBaseRepositoryOracle, IUsuarioRepository{
        ...
        public async Task<Object> Insert(Object Obj){
            ...
            Usuario Model = new Usuario(){ Nr_id = await GetNextValSequence(TBL_USUARIO.NR_ID.SEQUENCE) };
        ...
        public async Task<IEnumerable<Object>> GetAll(){
            ...
            Models.AddRange(await instituicaoRepository.GetAll());
            Models.AddRange(await universitarioRepository.GetAll());
